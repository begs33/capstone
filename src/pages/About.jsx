  ...
  return (
    <>
      ...
      <Section>
        <Container>
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-section mb-12">Education & Certification</h2>
            <div
              role="list"
      ...
      <Section>
        <Container>
          <div className="max-w-6xl mx-auto">
            ...
            <p className="body-default text-white/70 max-w-2xl mx-auto text-center mb-12">
              {aboutData.bio.personal}
            </p>
            <div
              role="list"
            ...
            >
              {aboutData.interests.map((interest) => (
                <article
                  key={interest.id}
                  className="card-base rounded-xl p-6 focus-within:ring-2
                  focus-within:ring-white/60 focus-within:ring-offset-2
                  focus-within:ring-offset-black overFlow-hidden hover:scale-[1.02] transition-transform duration-200"
                  role="listitem"
                >
                  {/* Image */}
